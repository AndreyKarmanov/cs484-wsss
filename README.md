...
[Download SAM](https://github.com/facebookresearch/segment-anything#model-checkpoints)
Download any of the SAM checkpoints (e.g., `vit_b`) and place it in the project directory.
